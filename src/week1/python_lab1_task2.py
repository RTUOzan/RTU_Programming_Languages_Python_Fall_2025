...
def greet_user(name):
    ...
    clean_name = name.strip().capitalize()  # TODO: implement cleaning and formatting
    return f"Hello, {clean_name}! Welcome to Python!"


if __name__ == "__main__":
    user_name = input("Enter your name: ")  # TODO: read name from input
    print(greet_user(user_name))  # TODO: print greeting
